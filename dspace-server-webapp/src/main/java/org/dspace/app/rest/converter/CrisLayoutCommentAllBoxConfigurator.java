 ...
 */
@Component
public class CrisLayoutCommentAllBoxConfigurator implements CrisLayoutBoxConfigurator {

    @Override
    public boolean support(CrisLayoutBox box) {
        return StringUtils.equals(box.getType(), CrisLayoutBoxTypes.COMMENT_ALL.name());
    }
    ...
    public CrisLayoutBoxConfigurationRest getConfiguration(CrisLayoutBox box) {
        ...
        StringBuilder discoveryConfiguration = new StringBuilder(CrisLayoutBoxTypes.COMMENT_ALL.name());
