...
public class ProjectConsumerIT extends AbstractControllerIntegrationTest {
    ...
    @Test
    public void projectConsumerCreateNewItemTest() throws Exception {
        ...
        configurationService.setProperty("project.subproject-community-id", subprojectsCommunity.getID().toString());
