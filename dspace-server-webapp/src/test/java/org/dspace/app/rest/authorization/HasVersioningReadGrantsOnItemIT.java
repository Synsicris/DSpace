...
public class HasVersioningReadGrantsOnItemIT extends AbstractControllerIntegrationTest {
    ...
    private AuthorizationFeature hasVersioningReadGrantsOnItem;
    ...
    public void setup() {
        ...
        hasVersioningReadGrantsOnItem = authorizationFeatureService.find(HasVersioningReadGrantsOnItem.NAME);
