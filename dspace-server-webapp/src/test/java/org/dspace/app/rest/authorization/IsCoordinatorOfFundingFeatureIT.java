...
import org.dspace.app.rest.authorization.impl.IsCoordinatorOfFundingFeature;
...
public class IsCoordinatorOfFundingFeatureIT extends AbstractControllerIntegrationTest {
    ...
    private AuthorizationFeature isCoordinatorOfFunding;
    ...
    public void setup() {
        ...
        isCoordinatorOfFunding = authorizationFeatureService.find(IsCoordinatorOfFundingFeature.NAME);
    ...
    public void testWithProjectMember() throws Exception {
        ...
        getClient(token).perform(get("/api/authz/authorizations/search/object")
            ...
            .param("feature", IsCoordinatorOfFundingFeature.NAME))
    ...
    public void testWithProjectAdmin() throws Exception {
        ...
        Authorization expectedAuthorization = new Authorization(admin, isCoordinatorOfFunding, itemRest);
    ...
    public void testWithSubProject() throws Exception {
        ...
        Authorization expectedAuthorization = new Authorization(user, isCoordinatorOfFunding, itemRest);
