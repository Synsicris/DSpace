...
import org.dspace.app.rest.authorization.impl.IsFunderReaderOfProgrammeFeature;
...
/**
 * ITs for the related Authorization Feature {@link IsFunderReaderOfProgrammeFeature}
 *
 * @author Vincenzo Mecca (vins01-4science - vincenzo.mecca at 4science.com)
 *
 */
public class IsFunderReaderOfProgrammeFeatureIT extends AbstractControllerIntegrationTest {
    ...
    private AuthorizationFeature isFunderReaderOfProgramme;
    ...
    public void setUp() throws Exception {
        ...
        isFunderReaderOfProgramme =
            authorizationFeatureService.find(IsFunderReaderOfProgrammeFeature.NAME);
    ...
    public void testIsFunderOrganizationalManagerOfProgrammeWhenContextUserIsInGroup() throws Exception {
        ...
        addUserToGroup(programmeItem, PROGRAMME_MEMBERS_GROUP_TEMPLATE, eperson);

        ItemRest projectItemRest = itemConverter.convert(projectItem, Projection.DEFAULT);
        boolean isAuthorized = isFunderReaderOfProgramme.isAuthorized(context, projectItemRest);
    ...
    public void testIsFunderOrganizationalManagerOfProgrammeWhenContextUserInGroupAndRelatedItemChecked()
        ...
        boolean isAuthorized = isFunderReaderOfProgramme.isAuthorized(context, fundingItemRest);
