...
<xsl:stylesheet version="1.1"
	...
	xmlns:pdf="http://xmlgraphics.apache.org/fop/extensions/pdf" exclude-result-prefixes="fo">
	...
	<xsl:param name="lang.frequency" select="'Häufigkeit'"/>
	...
	<xsl:param name="lang.participant-number" select="'Anzahl Teilnehmende'"/>
	...
	<xsl:param name="lang.spinoff.title-funding-table" select="'Unterstützungsleistung'"/>
	...
	<xsl:param name="lang.spinoff.title-performance-table" select="'Wirtschaftliche Entwicklung'"/>
	...
	<xsl:template match="cerif:Project">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:layout-master-set>
				...
				<fo:simple-page-master master-name="A4-portrait" page-height="29.7cm" page-width="24cm" margin-top="2cm" margin-bottom="2cm" margin-left="1cm" margin-right="1cm">
				...
				<fo:simple-page-master master-name="A4-landscape" page-height="24cm" page-width="29.7cm" margin-top="1cm" margin-bottom="1cm" margin-left="2cm" margin-right="2cm">
		...
		<xsl:for-each select="$entity">
			...
			<xsl:if test="count(cerif:Frequency/cerif:Index) > 0">
				...
				<fo:table table-layout="fixed" vertical-align="middle" border-before-style="hidden" border-after-style="hidden" border-start-style="hidden" border-end-style="hidden">
					...
					<!-- this construct is used to align the table in a centred way	-->
					<fo:table-column column-width="25.0%"/>
					<fo:table-column column-width="25.0%"/>
					<fo:table-column column-width="25.0%"/>
					<fo:table-column column-width="25.0%"/>
					<fo:table-column column-width="proportional-column-width(1)"/>
					<!-- this is also part of central alignment approach -->
	...
	this construct is used to align the table in a centred way							
							...
							<fo:table-body>
								<fo:table-row>
									...
									<!-- left column -->
									<fo:table-cell column-number="2" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}" border-start-style="hidden" border-end-style="hidden" margin-left="{$margin.left.table-cell}">
									...
									<!-- right column -->
									<fo:table-cell column-number="3" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}" border-start-style="hidden" border-end-style="hidden">
	...
	<xsl:template name="interaction-transfer-overview">
		...
		<fo:block margin-top="{$margin.top.main}" padding-before="{$padding.before.border}" padding-after="{$padding.after.border}" padding-start="{$padding.start.border}" padding-end="{$padding.end.border}">
			...
			<fo:table table-layout="fixed" vertical-align="middle">
				...
				<fo:table-header>
					...
					<!-- event -->
					<fo:table-cell column-number="2" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
					...
					<!-- process event -->
					<fo:table-cell column-number="3" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
					...
					<!-- physical object -->
					<fo:table-cell column-number="4" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
					...
					<!-- planned publication -->
					<fo:table-cell column-number="5" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
					...
					<!-- publication -->
					<fo:table-cell column-number="6" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
					...
					<!-- product -->
					<fo:table-cell column-number="7" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
		...
		<fo:block margin-top="{$margin.top.main}" padding-before="{$padding.before.border}" padding-after="{$padding.after.border}" padding-start="{$padding.start.border}" padding-end="{$padding.end.border}">
			...
			<fo:table table-layout="fixed" vertical-align="middle">
				...
				<fo:table-header>
					...
					<!-- further steps -->
					<fo:table-cell column-number="8" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
					...
					<!-- award -->
					<fo:table-cell column-number="9" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
					...
					<fo:table-cell column-number="10" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
				...
				<fo:block border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}" margin-top="{$margin.top.main}" margin-left="{$margin.left.border}" margin-right="{$margin.right.border}" padding-before="{$padding.before.border}" padding-after="{$padding.after.border}" padding-start="{$padding.start.border}" padding-end="{$padding.end.border}">
					...
					<xsl:if test="count(cerif:Funding/cerif:Index) > 0">
						...
						<xsl:if test="count(cerif:Performance/cerif:Index) > 0">
							<xsl:call-template name="title">
								<xsl:with-param name="title" select="$lang.spinoff.title-funding-table"/>
								<xsl:with-param name="fontSize" select="$font.size.standard"/>
							</xsl:call-template>
						</xsl:if>
					...
					<xsl:if test="count(cerif:Performance/cerif:Index) > 0">
						...
						<xsl:if test="count(cerif:Funding/cerif:Index) > 0">
							<xsl:call-template name="title">
								<xsl:with-param name="title" select="$lang.spinoff.title-performance-table"/>
								<xsl:with-param name="fontSize" select="$font.size.standard"/>
							</xsl:call-template>
						</xsl:if>
						...
						<fo:table table-layout="fixed" vertical-align="middle" border-before-style="hidden" border-after-style="hidden" border-start-style="hidden" border-end-style="hidden">
							...
							<fo:table-header>
								...
								<fo:table-cell column-number="4" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}" border-end-style="hidden" margin-left="{$margin.left.table-cell}">
		...
		<xsl:if test="cerif:Award">
			...
			<xsl:for-each select="cerif:Award/cerif:Index">
				...
				<fo:block border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}" margin-top="{$margin.top.main}" margin-left="{$margin.left.border}" margin-right="{$margin.right.border}" padding-before="{$padding.before.border}" padding-after="{$padding.after.border}" padding-start="{$padding.start.border}" padding-end="{$padding.end.border}">
					...
					<xsl:call-template name="label-amount-currency-below">
		...
		<xsl:if test="cerif:ExpectedSocietalImpact">
			...
			<xsl:for-each select="cerif:ExpectedSocietalImpact/cerif:Index">
				...
				<fo:block border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}" margin-top="{$margin.top.main}" margin-left="{$margin.left.border}" margin-right="{$margin.right.border}" padding-before="{$padding.before.border}" padding-after="{$padding.after.border}" padding-start="{$padding.start.border}" padding-end="{$padding.end.border}">
					...
					<!-- type table -->
					<xsl:if test="count(cerif:Type/cerif:Index) > 0">
		...
		<xsl:if test="cerif:Ethic">
			...
			<xsl:for-each select="cerif:Ethic/cerif:Index">
				...
				<fo:block border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}" margin-top="{$margin.top.main}" margin-left="{$margin.left.border}" margin-right="{$margin.right.border}" padding-before="{$padding.before.border}" padding-after="{$padding.after.border}" padding-start="{$padding.start.border}" padding-end="{$padding.end.border}">
					...
					<!-- since after the title comes a table it needs to be checked if we need a ruler or not -->
					<xsl:choose>
						<xsl:when test="count(cerif:Reflection/cerif:Index) > 0 or cerif:FurtherDocuments">
					...
					<!-- reflection table -->
					<xsl:if test="count(cerif:Reflection/cerif:Index) > 0">
						...
						<fo:table table-layout="fixed" vertical-align="middle" border-before-style="hidden" border-after-style="hidden" border-start-style="hidden" border-end-style="hidden">
							...
							<fo:table-header>
								...
								<fo:table-cell column-number="3" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}" border-end-style="hidden" margin-left="{$margin.left.table-cell}">
					...
					<fo:table-body>
						...
						<xsl:if test="count(cerif:ProjectPartner/cerif:Index) > 0">
							...
							<fo:table-row>
								...
								<fo:table-cell column-number="2" number-columns-spanned="4" border-width="{$width.border}" border-color="{$colour.border}" border-style="{$style.border}">
	...
	<xsl:template name="vertical-gap">
		...
		<fo:block margin-left="{$margin.left.border}" margin-top="{$margin}">
		</fo:block>
	...
	<xsl:template name="empty-table-cell-catcher">
		...
		<fo:block text-align="{$alignment}" font-size="{$fontSize}" font-weight="{$fontWeight}" margin-top="{$margin.top.main}" padding-before="{$padding.before.border}" padding-after="{$padding.after.border}" padding-start="{$padding.start.border}" padding-end="{$padding.end.border}" margin-left="{$margin.left.border}" margin-right="{$margin.right.border}">
	...
	<xsl:template name="title">
		...
		<fo:block margin-left="{$margin.left.border}" margin-top="{$margin.top.title}" font-size="{$fontSize}">

			<fo:inline font-weight="{$font.weight.title}" text-align="{$text.alignment.title}">
	...
	<xsl:template name="value-single">
		...
		<xsl:param name="addRulerBelow" select="'false'"/>

		<xsl:if test="$value">

			<xsl:if test="$addRulerAbove = 'true'">
				<xsl:call-template name="ruler"/>
			</xsl:if>

			<fo:block margin-left="{$margin.left.border}" font-size="{$fontSize}" margin-top="{$margin.top.main}">

				<fo:inline font-weight="{$fontWeight}" text-align="{$text.alignment.value}">
					<xsl:value-of select="$value"/>
				</fo:inline>

			</fo:block>

			<xsl:if test="$addRulerBelow = 'true'">
				<xsl:call-template name="ruler"/>
			</xsl:if>
	...
	<xsl:template name="value-nace-destatis-table">
		...
		<xsl:choose>
			<xsl:when test="$nace or $destatis">
	...
	<xsl:template name="value-issue-date-author-table">
		...
		<xsl:choose>
			<xsl:when test="$issueDate or $author">
	...
	<xsl:template name="value-publication-information-table">
		...
		<xsl:choose>
			<xsl:when test="$isPartOf or $journal or $volume or $issue or $startPage or $endPage or $identifier">
	...
	<xsl:template name="value-postcode-city-country">
		...
		<xsl:if test="$city">			<!--  use only city for check, this seems the most probable input -->
			<fo:block margin-left="{$margin.left.border}" font-size="{$font.size.standard}" margin-top="{$margin.top.main}">

				<fo:inline font-weight="{$font.weight.value}" text-align="{$text.alignment.value}">
	...
	<!--==============================================================-->
	<!-- value set with postcode, city and and country in a table cell -->
	<!--==============================================================-->

	<xsl:template name="value-postcode-city-country-table">
		<xsl:param name="postCode"/>
		<xsl:param name="city"/>
		<xsl:param name="country"/>
		<xsl:param name="fontSize" select="$font.size.standard"/>
		...
		<xsl:choose>
			<xsl:when test="$city">				<!--  use only city for check, this seems the most probable input -->
	...
	<!--==============================================================-->
	<!-- value set with period in a table cell (duration is assumed to be in hours)  -->
	<!--==============================================================-->

	<xsl:template name="value-period-table">
	...
	<xsl:template name="label-block">
		...
		<xsl:if test="$label">
			...
			<fo:block margin-left="{$margin.left.border}" margin-top="{$margin.top.main}" font-size="{$fontSize}" color="{$colour.label}">

				<fo:inline font-weight="{$font.weight.label}" text-align="{$text.alignment.label}">
	...
	<xsl:template name="label-value-single">
		...
		<xsl:if test="$value">
			...
			<fo:block margin-left="{$margin.left.border}" font-size="{$font.size.standard}" margin-top="{$margin.top.main}">
				...
				<fo:inline font-weight="{$font.weight.label}" text-align="{$text.alignment.label}" color="{$colour.label}">
					<xsl:value-of select="$label"/>
					<xsl:text>: </xsl:text>
				</fo:inline>
		...
		<xsl:choose>
			<xsl:when test="$checkValue = 'true'">
				...
				<xsl:if test="$value">
					...
					<!-- label -->
					<fo:block margin-left="{$margin.left.border}" font-size="{$font.size.label-below}" margin-top="{$margin.top.main}">
					...
					<!-- value below -->
					<fo:block margin-left="{$margin.left.border}" font-size="{$font.size.standard}" margin-top="{$margin.top.label-below}">
	...
	<!--==============================================================-->
	<!-- label: amount and currency (below)-->
	<!--==============================================================-->

	<xsl:template name="label-amount-currency-below">
		<xsl:param name="label"/>
	...
	<xsl:template name="label-value-line-list-below">
		...
		<xsl:if test="$value">			<!-- do only if there are values -->
			...
			<!-- value below -->
			<fo:list-block margin-left="{$margin.left.border}" font-size="{$font.size.standard}" margin-top="{$margin.top.label-below}" font-weight="{$font.weight.value}" text-align="{$text.alignment.value}">
				...
				<xsl:for-each select="$value">
					<fo:list-item>
						...
						<fo:list-item-body font-weight="{$font.weight.value}" text-align="{$text.alignment.value}">
							<fo:block>-								<xsl:value-of select="current()"/>
							</fo:block>
						</fo:list-item-body>
